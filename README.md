...
View SierraDataset3.ipynb within this repository to view the python code, which you can use in googfle colab generate the following interactive maps and graphs in your own browser:
...
- [Sediment Mercury Map](https://www.dropbox.com/scl/fi/tgns522y9qcax2acwg4ek/sediment_mercury_map.html?rlkey=plg9fnda8f6rzwrohwr77vhqg&st=jjus9mqs&dl=0)
...
## Note: For these analysis, they didn't check the downstream/valley - only the mining sites 
